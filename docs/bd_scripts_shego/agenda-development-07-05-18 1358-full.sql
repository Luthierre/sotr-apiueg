...
insert  into `schema_version`(`version_rank`,`installed_rank`,`version`,`description`,`type`,`script`,`checksum`,`installed_by`,`installed_on`,`execution_time`,`success`) values (1,1,'01','criar tabelas departamento contato telefones','SQL','V01__criar_tabelas_departamento_contato_telefones.sql',-1537142455,'root','2018-05-07 10:24:54',700,1),(2,2,'02','criar e registrar usuarios e premissoes','SQL','V02__criar_e_registrar_usuarios_e_premissoes.sql',2044355053,'root','2018-05-07 10:24:55',796,1);
...
insert  into `usuario`(`codigo`,`nome`,`email`,`senha`) values (1,'Suporte','ti.santahelena@ueg.br','$2a$10$OVfTgA9P6rha79iS8hhpfekzNIsSq.HujSoOn8ZqOv1Nzlvty/DbG'),(2,'Secretaria','sec.santahelena@ueg.br','$2a$10$E7cGOWD77Kz6adspmj8OguLKAa9pGOeZ2enFSNEQQkWSVsYixoToi'),(3,'Marcial Rocha','marcial.silva@ueg.br','$2a$10$GLrdEaqx1JvBuwXgfAaIn.S6Mm7nO.PySj2uNwqngfkBGGPj4ePqy'),(4,'Nilcyneia','dir.santahelena@ueg.br','$2a$10$Ml/NsUKLfOE2.LQ89Obdruy0uz1Ih5quEQdSAs//4YUzDMUVez92C');
...
insert  into `usuario_permissao`(`codigo_usuario`,`codigo_permissao`) values (1,1),(2,1),(3,1),(4,1),(1,2),(2,2),(3,2),(4,2),(1,3),(3,3),(4,3),(1,4),(2,4),(3,4),(4,4),(1,5),(2,5),(3,5),(4,5),(1,6),(2,6),(3,6),(4,6),(1,7),(1,8),(1,9),(1,10),(3,10),(4,10),(1,11),(2,11),(3,11),(4,11),(1,12),(2,12);
